...
prompt = {'Participant ID:' 
          ...
          'Gender (f/m/d):'
          'EEG Cap size (cm):' 
          'Surveyid_soscisurvey:'
          };
defaultAnswer = {'01','99','x', 'x','x'};
numLines = 1;
...
p_data.ID = answer{1};
p_data.age_years = answer{2};
p_data.gender_fmd = answer{3};
p_data.capsize_cm = answer{4};
p_data.surveyid_soscisurvey = answer{5};
