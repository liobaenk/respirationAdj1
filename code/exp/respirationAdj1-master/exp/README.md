...
* respirationAdj1.m - main script to control experiment by executing sections step-by-step
* exp\_init\_NI.m - helper function to initialize experiment
* respirationAdj1/ - directory with code for experimental block
* respirationAdj\_rest\_state.m - first part of the experiment, resting state 
